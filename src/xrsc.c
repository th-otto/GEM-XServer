...
static char __mem[1024 * 1024 * 2];
static char *__ptr = __mem;
...
/* ============================================================================== */
void _xrsc_pool_init(p_XRSCPOOL pool, size_t size)
{
...
/* ============================================================================== */
void _xrsc_insert(p_XRSCPOOL pool, p_XRSC r)
{
...
/* ============================================================================== */
p_XRSC _xrsc_create(p_XRSCPOOL pool, CARD32 id, size_t size)
{
	...
	{
		x_printf("_xrsc_create(%lX,%li): memory exhausted.\n", id, size);
	}
	return r;
}
...
/* ============================================================================== */
BOOL _xrsc_remove(p_XRSCPOOL pool, p_XRSC r)
{
	p_XRSC *p = &pool->item[r->Id & pool->mask_bits];
...
/* ============================================================================== */
BOOL _xrsc_delete(p_XRSCPOOL pool, p_XRSC r)
{
...
/* ============================================================================== */
p_XRSC _xrsc_search(const struct s_XRSCPOOL *pool, CARD32 id)
{
