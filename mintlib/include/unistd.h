...
__EXTERN int	execl	__PROTO((const char *, __const char *__arg, ...));
__EXTERN int	execle	__PROTO((const char *, __const char *__arg, ...));
__EXTERN int	execlp	__PROTO((const char *, __const char *__arg, ...));
